...
class CompositePrintStream extends PrintStream {
  ...
  public void print(boolean b) {
    _streams.forEach(s -> print(b));
  }

  /** @see java.io.PrintStream#print(char) */
  @Override
  public void print(char c) {
    _streams.forEach(s -> print(c));
  }
  ...
  public void println(double d) {
    _streams.forEach(s -> println(d));
  }

  /** @see java.io.PrintStream#println(float) */
  @Override
  public void println(float f) {
    _streams.forEach(s -> println(f));
  }

  /** @see java.io.PrintStream#println(int) */
  @Override
  public void println(int i) {
    _streams.forEach(s -> println(i));
  }

  /** @see java.io.PrintStream#println(long) */
  @Override
  public void println(long l) {
    _streams.forEach(s -> println(l));
  }

  /** @see java.io.PrintStream#println(Object) */
  @Override
  public void println(Object obj) {
    _streams.forEach(s -> println(obj));
  }

  /** @see java.io.PrintStream#println(String) */
  @Override
  public void println(String str) {
    _streams.forEach(s -> println(str));
  }
  ...
  public void write(byte[] buf, int off, int len) {
    _streams.forEach(s -> write(buf, off, len));
  }

  /** @see java.io.PrintStream#write(int) */
  @Override
  public void write(int b) {
    _streams.forEach(s -> write(b));
  }
